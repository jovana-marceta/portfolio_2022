    ...
    <div name='skills' className='w-full h-full bg-violet-600 text-white'>
      <div className='max-w-[1240px] mx-auto p-4 flex flex-col justify-center w-full'>
        <div>
          ...
          <p className='py-4'>
            Below is a list of my skills. I am trying to stay up with the newest
            trends in the industry and to keep learning and becoming a better
            version of myself. When we improve our lives, we can improve others
            too. I am always willing to learn new things and cooperate with
            other enthusiastic individuals.
          </p>
        </div>
